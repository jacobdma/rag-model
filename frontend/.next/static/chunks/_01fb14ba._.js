...
;
;
function Sidebar({ chats, sidebarOpen, activeChatId, setActiveChatId, createNewChat, deleteChat, currentChatIsEmpty }) {
    function generateChatTitle(message) {
        ...
        if ([
            ...
            return `Question: ${firstFew}`;
        } else if (lower.startsWith("generate") || lower.startsWith("create")) {
            return `Request: ${firstFew}`;
        } else {
            return `Topic: ${firstFew}`;
        }
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: `
...
function Chat() {
    ...
    function deleteChat(chatId) {
        ...
        // If the active one is deleted, fallback to another or none
...
//# sourceMappingURL=_01fb14ba._.js.map